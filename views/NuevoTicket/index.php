	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<p>
					Desde esta ventana podra generar nuevos tickets de CoreptecDesk!.
				</p>
				...
				<div class="row">
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput">Requerimiento</label>
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput">Selecciona una opcion:</label>
								<select id="opci_id" name="opci_id" class="form-control">
						...
						<!--<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput">Comentario:</label>
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								<label class="form-label semibold" for="tick_descrip">Descripción / maximo 9.000 palabras</label>
