            ...
            <div class="tbl-row">
              <div class="tbl-cell">
                ...
                <ol class="breadcrumb breadcrumb-simple">
                  ...
                  <li class="active" id="lblestado"></li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="row">
              <div class="col-lg-2">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="req_nom">Usuario</label>
                  <input type="text" class="form-control" id="lblnomusuario" name="lblnomusuario" readonly>
                </fieldset>
              </div>
              <div class="col-lg-2">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="req_nom">Soporte</label>
                  <input type="text" class="form-control" id="lblnomsoporte" name="lblnomsoporte" readonly>
                </fieldset>
              </div>
              <div class="col-lg-2">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="req_nom">Fecha Creación</label>
                  <input type="datetime" class="form-control" id="lblfechcrea" name="lblfechcrea" readonly>
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset class="form-group">
              ...
              <div class="col-lg-4">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="req_nom">Requerimiento</label>
                  <input type="text" class="form-control" id="req_nom" name="req_nom" readonly>
                </fieldset>
              </div>
        ...
        <div class="box-typical box-typical-padding" id="pnldetalle">
          ...
          <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <button type="button" id="btncerrarticket" class="btn btn-rounded btn-inline btn-warning">Terminar Ticket</button>
              </div>
          </div>
			  </div>
